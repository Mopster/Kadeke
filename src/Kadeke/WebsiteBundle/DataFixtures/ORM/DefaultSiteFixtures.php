...
namespace Kadeke\WebsiteBundle\DataFixtures\ORM;
...
class DefaultSiteFixtures extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    ...
    {
        $homepage = $this->createAndPersistPage($manager, 'Kadeke\WebsiteBundle\Entity\HomePage', $title, null, "", "homepage");
        {
    ...
    {
        return $this->createAndPersistPage($manager, 'Kadeke\WebsiteBundle\Entity\ContentPage', $title, $parent);
    }
    ...
    {
        $page = $this->createAndPersistPage($manager, 'Kadeke\WebsiteBundle\Entity\FormPage', $title, $parent);
