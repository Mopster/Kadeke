# Main
set :application, "kadeke"
set :use_sudo, true
set :admin_runner, "kadeke"
set :keep_releases, 5
...
set :newrelic_appname, "kadeke" # The name of the application in newrelic
set :newrelic_license_key, "0e62b947e86dcf9d43f8aa470cf57824de66ed87" # The license key can be found under 'Account settings'
